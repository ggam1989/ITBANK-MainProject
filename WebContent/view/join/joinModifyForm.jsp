...
<div id="join">
	<form name="frm" action="joinModify" method="post" enctype="multipart/form-data">
		...
		<table cellpading="1" cellspacing="1" border="0">
			...
			<tr>
				...
				<td colspan="2" align="center">
					...
					<input type="button" value="취소" onclick="location.href='joinModifyForm?j_id=${bean.j_id}'">
					<input type="button" 	value="뒤로" 
					onclick="location.href='joinDetail?j_id=${bean.j_id}'"></td>
			</tr>
